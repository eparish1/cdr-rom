...
Phi = Phi[:,0:K]
print(np.shape(Phi))
romProblem = romProblemClass(femProblem,Phi,basis_type,methodContinuous,methodDiscrete,dt,et,0.)
#===========
...
for tau in tau_array:
  romProblem.tau = tau #this is tau for the discrete ROMs (APG)
  romProblem.femProblem.tau= tau #this is tau for the continuous ROMs, e.g., SUPG 
